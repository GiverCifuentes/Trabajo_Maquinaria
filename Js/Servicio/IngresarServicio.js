$(document).ready(function(){
    $("#btnregistrar_servicio").click(function(){

        let validado = 0;
        if($("#NombreObra").val().length == 0){
        ...
        Swal.fire({
            icon: 'success',
            title: 'Servicio agendada',
            text: 'La servicio se agendo con éxito',
...
$(document).ready(function(){
    $("#FrmServicio").submit(function( event )
    {
...
$(document).ready(function(){
    $("#btnconsultar_servicio").click(function(){

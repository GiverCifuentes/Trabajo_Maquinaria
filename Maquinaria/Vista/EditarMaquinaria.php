...
<body style="background-color: rgb(0, 0, 0);">
    ...
    <div style="background-color: #B52407;" class="card text-white mb-3">
        <div class="card-header">Ingrese los datos para editar la máquina</div>
        <div class="card-body">
    <form id="FrmMaquinaria" name="FrmMaquinaria" action="../Controlador/ControladorMaquinaria.php" method="POST">
        <div class="form-group"style="text-align:center;">
        Id máquina:
        <br>
        <input type="text" id="IdMaquina" name="IdMaquina" readonly value="<?php echo $Maquinaria->getIdMaquina();?>">
        <br>
        </div>
        <div class="form-group"style="text-align:center;">
        ...
        <button type="submit"  class="btn btn-success" name="btnregistrar_Maquinaria" id="btnregistrar_Maquinaria ">Editar Máquina</button>
    ...
    <br>
    <button  class="btn btn-info" onclick="location.href='ListarMaquinaria.php'"> Volver</button>

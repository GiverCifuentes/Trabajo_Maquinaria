 ...
 */
define ('PDF_HEADER_LOGO', 'Captura.png'); // Incluyendo el logo

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 20); // Cambiar ancho del logo
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'CRUD 756');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Giver Cifuentes - Database Globant");
